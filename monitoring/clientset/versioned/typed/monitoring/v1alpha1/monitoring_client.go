...
import (
	...
	"github.com/kubeall/client-go/monitoring/clientset/versioned/scheme"
...
// MonitoringV1alpha1Client is used to interact with features provided by the monitoring.kubeall.com group.
type MonitoringV1alpha1Client struct {
	restClient rest.Interface
}

func (c *MonitoringV1alpha1Client) ProjectArchitectures(namespace string) ProjectArchitectureInterface {
