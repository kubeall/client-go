...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("kubeusers"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Cluster().V1alpha1().KubeUsers().Informer()}, nil
	case v1alpha1.SchemeGroupVersion.WithResource("userkubeconfigs"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Cluster().V1alpha1().UserKubeConfigs().Informer()}, nil
